...
//.........................
angular.module('hash').service('userService', function($localStorage, $rootScope) {
    var service = this,
        currentUser = null;
    ...
    service.setCurrentUser = function(user) {
        ...
        $rootScope.haUser = user;
        $rootScope.haLoggedUser = true;
    ...
    service.getCurrentUser = function() {
        if (currentUser!=null) {
        	service.setCurrentUser($localStorage.user);
        }
        return currentUser;
    };
    ...
    service.resetCurrentUser = function() {
        ...
        delete $rootScope.haUser;
        $rootScope.haLoggedUser = false;
        $rootScope.$broadcast('unauthenticated');
    };
    
    service.isLoggedUser = function() {
        return currentUser!=null;
    };
});

//INITIALIZE the 'userService' service
angular.module('hash').run(function(userService) {
	userService.resetCurrentUser();
});

//ADD 'authInterceptor' service
//.............................
angular.module('hash').factory('authInterceptor',
	function($rootScope, $q, $window) {
		return {
			request : function(config) {
				config.headers = config.headers || {};
				if ($window.sessionStorage.token) {
					alert('Bearer ' + $window.sessionStorage.token);
...
angular.module('hash').config(function($httpProvider) {
	$httpProvider.interceptors.push('authInterceptor');
});



//ADD 'logger' service via PROVIDER
//.................................
angular.module('hash').provider('logger', function() {
  this.url = undefined;
  
  // $get function returning the service
  this.$get = function($http, $rootScope, $window, userService){
	var url = this.url;
	return {
		// <<login>> function
		// ------------------
...
// ADD 'broker' service
//.....................
angular.module('hash').service('broker', function() {
	var instance = this;
...
angular.module('hash').run(function($q, broker) {
...
// .............................
angular.module('hash').directive('btSmartbutton', function(broker, $state) {
	return {
		replace: false,
		scope: {
			title:'@',
...
angular.module('hash').directive('btMulti', function() {
	return {
		replace: false,
		scope: {
			number:'@'
...
//..............................
angular.module('hash').directive('loginComponent', function(logger, userService) {
	return {
		replace: false,
		scope: true,
...
angular.module('hash').directive('identificator', function($q, logger, $timeout) {
  return {
    require: 'ngModel',
	controller: function($scope, $window, $element){
...
angular.module('hash').directive('rePassword', function() {
  return {
    require: 'ngModel',
    link: function(scope, elm, attrs, ctrl) {
        // set SYNC validator
